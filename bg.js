    ...
    if(highload === 30){
        chrome.storage.sync.get('notification', function(res){
            if(res.notification == true || res.notification == 'undefined'){
                fetch('https://raw.githubusercontent.com/satish15697/No-Coin/blob/master/ignore.json').then(function(response) {
...
function start(){
    fetch('https://raw.githubusercontent.com/satish15697/No-Coin/blob/master/blacklist.json').then(function(response) {
